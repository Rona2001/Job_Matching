...
def get_all_best_match_offers(candidate_id):
    ...
    Returns:
        list: A list of dictionaries containing the best match job offers and their similarity scores.
    """
...
# Example usage
candidate_id = 'hVI9m1QnViUgvCNkyoP9wGosuDU2'  # Change this to the ID of the candidate you want to find the best match offers for
